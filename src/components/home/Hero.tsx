...
const Hero = () => {
  return (
    <section className="relative w-full overflow-hidden mt-4">
      ...
      {/* Bottom Content */}
      <div className="absolute bottom-0 left-0 right-0 md:left-auto md:right-0 md:w-[45%] z-10 pb-6 md:pb-12 animate-fade-up flex-col md:items-center flex items-end justify-end px-[70px] md:px-[35px]">
        <Button
          variant="hero"
