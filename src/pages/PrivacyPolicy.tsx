      ...
      <section className="py-12 md:py-16">
        <div className="max-w-4xl mx-auto px-4 md:px-6">
          ...
          >
            ...
            <h2 className="font-display text-2xl md:text-3xl text-foreground mt-12 mb-6">
            ...
            <p className="mb-8">
              ...
              <a href="https://www.shopify.com/legal/privacy" target="_blank" rel="noopener noreferrer" className="text-primary underline hover:text-primary/80">
                Shopify Consumer Privacy Policy
              </a>. Depending on where you live, you may exercise certain rights with respect to your personal information at the{" "}
              <a href="https://privacy.shopify.com" target="_blank" rel="noopener noreferrer" className="text-primary underline hover:text-primary/80">
            ...
            <p className="mb-8">
              ...
              <a href="https://privacy.shopify.com/en" target="_blank" rel="noopener noreferrer" className="text-primary underline hover:text-primary/80">
