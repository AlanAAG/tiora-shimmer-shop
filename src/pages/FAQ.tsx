...
const faqSections = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer: "Yes, 100%. The \"green ring\" on skin is caused by chemical reactions with copper or nickel found in cheap brass jewellery. Tiora pieces use a Surgical-Grade Stainless Steel core which is biologically inert and Nickel-Free. It will never rust, oxidize, or leave a green mark on your skin, even in the Indian heat.",
      },
      {
      ...
      },
      {
        ...
        answer: "Yes. We use 18k Gold for our plating, which gives a warm, rich tone (unlike the fake \"yellow\" look of 24k plating). It matches perfectly with your existing fine gold jewellery.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        answer: "We maintain strict quality standards. Therefore, we do not offer exchanges or replacements. However, if you are not completely satisfied, you may return the item for a Refund Only, subject to inspection.\n\nEligibility: The request must be raised within the allowed timeframe. The product must be unused, unworn, with original tags and packaging intact.\n\nProcess: Once your return is approved via email, you will receive instructions to ship the product back to us.\n\nRefund: Upon passing inspection, 100% of the purchase amount (excluding shipping charges) will be refunded to your original payment method.",
      },
      {
        question: "What if I receive a damaged product?",
        answer: "We take quality control seriously. However, in the rare event of damage during transit, complaints must be reported within 24 hours of delivery along with clear photo/video proof. Please email our support team immediately, and we will resolve it for you.",
      },
    ],
  },
];
